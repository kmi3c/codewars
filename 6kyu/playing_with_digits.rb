...
# such as the sum of the digits of n taken to the successive powers of p
...
# dig_pow(92, 1) should return -1 since there is no k such as:
#   9^1 + 2^2 equals 92 * k
# dig_pow(695, 2) should return 2 since 6^2 + 9^3 + 5^4= 1390 = 695 * 2
# dig_pow(46288, 3) should return 51 since:
# 4^3 + 6^4+ 2^5 + 8^6 + 8^7 = 2360688 = 46288 * 51
def dig_pow(_n, _p)
  1
end
